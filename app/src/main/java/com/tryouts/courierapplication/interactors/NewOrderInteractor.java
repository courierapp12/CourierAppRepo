...
public class NewOrderInteractor {
    ...
    public NewOrderInteractor(NewOrderPresenter presenter) {
        ...
        this.mFromAddressLatLng=new LatLng(38.898748, -77.037684);
        this.mToAddressLatLng=new LatLng(34.101509,-118.32691);
        addressFrom="Pennysylvania";
        addressTo="Los Angeles";
        this.distance="5";
        setDistance("5");
    ...
    public void onPlaceAutocompleteCall(int requestCode) throws GooglePlayServicesNotAvailableException, GooglePlayServicesRepairableException {
        ...
        AutocompleteFilter typeFilter = new AutocompleteFilter.Builder()
              ...
              .build();
        //Toast.makeText(ge, "Show - 1", Toast.LENGTH_SHORT).show();
        Log.i("show-1","show-1");
      ...
      /*  Log.i("show-2","show-2");
        Places.initialize(mFragmentActivity,"AIzaSyD7t9iCUiGpxQGR47eFshnq8TSRKEl23Fo");
        List<Place.Field> Fieldset = Arrays.asList(Place.Field.ADDRESS,
                Place.Field.LAT_LNG,Place.Field.NAME);

        mPlacesAutocompleteIntent = new Autocomplete.IntentBuilder(AutocompleteActivityMode.OVERLAY,Fieldset)
                .build(mFragmentActivity);*/
