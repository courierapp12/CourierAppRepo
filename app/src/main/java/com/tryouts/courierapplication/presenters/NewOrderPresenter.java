...
public class NewOrderPresenter {
     ...
     *
     */
    public void onActivityResultCalled(int requestCode, int resultCode) throws GooglePlayServicesNotAvailableException, GooglePlayServicesRepairableException {
        if(requestCode == 1) {
    ...
    public void setMapView() {
        ...
        if(!mModel.areFromToReceived()) {
            ...
            Log.i("MapLocation",mModel.getDefaultLatitude()+" "+mModel.getDefaultLongitude()+" "+mModel.getDistance());
    ...
    public void createListenerForPlaceAutocompleteCall(int requestCode) throws GooglePlayServicesNotAvailableException, GooglePlayServicesRepairableException {
    ...
    public void onReadyStartActivityForResult1(Intent intent, int requestCode) {
